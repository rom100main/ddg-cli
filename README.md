...
> [!NOTE] 
> For a more up-to-date alternative with a TUI and no rate limits (using the Brave Search API instead of scraping), check out [brave-cli](https://github.com/rom100main/brave-cli) ([@rom100main/brave-cli](https://www.npmjs.com/package/@rom100main/brave-cli) on npm).
